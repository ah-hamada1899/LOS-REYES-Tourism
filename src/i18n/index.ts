...
const resources = {
  en: {
    translation: {
      ...
      'inquire.title': 'Begin Your Personal Odyssey',
      'inquire.subtitle': 'Crafting bespoke expeditions through the cradle of civilization, tailored to your exact desires.',
      'inquire.form.title': 'Design Your Journey',
      'inquire.form.name': 'Name',
      'inquire.form.email': 'Email',
      'inquire.form.destination': 'Destination Interests',
      'inquire.form.destination.placeholder': 'Select your primary destination',
      'inquire.form.destination.cairo': 'Cairo',
      'inquire.form.destination.luxor': 'Luxor',
      'inquire.form.destination.aswan': 'Aswan',
      'inquire.form.destination.redsea': 'Red Sea',
      'inquire.form.arrival': 'Arrival Date',
      'inquire.form.departure': 'Departure Date',
      'inquire.form.adults': 'Adults',
      'inquire.form.children.under2': 'Children (< 2y)',
      'inquire.form.children.under10': 'Children (< 10y)',
      'inquire.form.passport': 'Passport Copy (Optional)',
      'inquire.form.passport.drag': 'Drag & drop or browse to upload',
      'inquire.form.passport.secure': 'Secure PDF or JPG up to 5MB',
      'inquire.form.details': 'Inquiry Details',
      'inquire.form.details.placeholder': 'Tell us about your dream Egyptian experience...',
      'inquire.form.submit': 'Request Itinerary',
      'inquire.concierge.title': 'Consult with Khalid',
      'inquire.concierge.role': 'Chief Travel Architect',
      'inquire.concierge.quote': '"Every stone in Egypt tells a story. My role is to ensure your journey becomes a chapter of its own, seamless and extraordinary."',
      'inquire.concierge.expert': 'Expert in Antiquity & Luxury',
      'inquire.trust.title': 'A LEGACY OF TRUST',
      'inquire.trust.security': 'Guaranteed Security',
      'inquire.trust.security.desc': 'Your safety is our highest honor. We provide discrete, professional security protocols for every step of your journey.',
      'inquire.trust.excellence': 'Verified Excellence',
      'inquire.trust.excellence.desc': 'As stewards of Egyptian heritage, our services are certified by the Ministry of Tourism for uncompromising quality.',
      'inquire.trust.hospitality': 'Honorable Hospitality',
      'inquire.trust.hospitality.desc': 'Rooted in the ancient tradition of welcoming guests, our 24/7 support treats you like family, not a traveler.',
      'inquire.newsletter.title': 'Stay Inspired',
      'inquire.newsletter.desc': 'Receive our quarterly compendium of curated Egyptian discoveries and exclusive private departures.',
      'inquire.newsletter.placeholder': 'Email Address',
      'inquire.newsletter.button': 'Join',
      'inquire.footer.discover': 'Discover',
      'inquire.footer.connect': 'Connect',
      'inquire.footer.contact': 'Contact',
    }
  },
  es: {
    translation: {
      ...
      // Inquire Page
      'inquire.title': 'Comience Su Odisea Personal',
      'inquire.subtitle': 'Creando expediciones personalizadas a través de la cuna de la civilización, adaptadas a sus deseos exactos.',
      'inquire.form.title': 'Diseñe Su Viaje',
      'inquire.form.name': 'Nombre',
      'inquire.form.email': 'Correo Electrónico',
      'inquire.form.destination': 'Intereses de Destino',
      'inquire.form.destination.placeholder': 'Seleccione su destino principal',
      'inquire.form.destination.cairo': 'El Cairo',
      'inquire.form.destination.luxor': 'Luxor',
      'inquire.form.destination.aswan': 'Asuán',
      'inquire.form.destination.redsea': 'Mar Rojo',
      'inquire.form.arrival': 'Fecha de Llegada',
      'inquire.form.departure': 'Fecha de Salida',
      'inquire.form.adults': 'Adultos',
      'inquire.form.children.under2': 'Niños (< 2 años)',
      'inquire.form.children.under10': 'Niños (< 10 años)',
      'inquire.form.passport': 'Copia de Pasaporte (Opcional)',
      'inquire.form.passport.drag': 'Arrastre o busque para subir',
      'inquire.form.passport.secure': 'PDF o JPG seguro hasta 5MB',
      'inquire.form.details': 'Detalles de Consulta',
      'inquire.form.details.placeholder': 'Cuéntenos sobre su experiencia egipcia soñada...',
      'inquire.form.submit': 'Solicitar Itinerario',
      'inquire.concierge.title': 'Consulte con Khalid',
      'inquire.concierge.role': 'Arquitecto Jefe de Viajes',
      'inquire.concierge.quote': '"Cada piedra en Egipto cuenta una historia. Mi papel es asegurar que su viaje se convierta en un capítulo propio, perfecto y extraordinario."',
      'inquire.concierge.expert': 'Experto en Antigüedad y Lujo',
      'inquire.trust.title': 'UN LEGADO DE CONFIANZA',
      'inquire.trust.security': 'Seguridad Garantizada',
      'inquire.trust.security.desc': 'Su seguridad es nuestro mayor honor. Proporcionamos protocolos de seguridad discretos y profesionales para cada paso de su viaje.',
      'inquire.trust.excellence': 'Excelencia Verificada',
      'inquire.trust.excellence.desc': 'Como guardianes del patrimonio egipcio, nuestros servicios están certificados por el Ministerio de Turismo por su calidad inigualable.',
      'inquire.trust.hospitality': 'Hospitalidad Honorable',
      'inquire.trust.hospitality.desc': 'Arraigados en la antigua tradición de dar la bienvenida a los huéspedes, nuestro soporte 24/7 le trata como a un familiar, no como a un viajero.',
      'inquire.newsletter.title': 'Manténgase Inspirado',
      'inquire.newsletter.desc': 'Reciba nuestro compendio trimestral de descubrimientos egipcios curados y salidas privadas exclusivas.',
      'inquire.newsletter.placeholder': 'Correo Electrónico',
      'inquire.newsletter.button': 'Unirse',
      'inquire.footer.discover': 'Descubrir',
      'inquire.footer.connect': 'Conectar',
      'inquire.footer.contact': 'Contacto',
    }
  }
}
